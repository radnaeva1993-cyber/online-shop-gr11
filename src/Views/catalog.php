...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-links">
            ...
            <?php // БАГ: ссылка "Выйти" вела на /login (как и "Войти"), то есть просто
            // открывала форму логина, а сессия/кука пользователя не уничтожались —
            // разлогиниться через интерфейс было в принципе нельзя. Теперь ведёт на
            // добавленный роут /logout (см. src/public/index.php). ?>
